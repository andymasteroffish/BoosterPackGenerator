...
You can edit settings.xml by opening it up with any text editing program. Sublime is a nice one: https://www.sublimetext.com/3
...
Each folder tag has as its value the file location on your computer of the folder that holds that set of images. Some text editors will allow you to drag a folder on your computer into the text and automatically paste the file location. 
...
As you can see in the more straight forward "commons" example, if a folder does not have a set chance attribute, it will default to 100.
